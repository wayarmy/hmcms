 ...
 *
 */
$HM_FRONTENT_DIR = HM_FRONTENT_DIR;
 
class SimpleCaptcha {

	public $hm_frontend  = 'hm_frontend';
    ...
    public function __construct($config = array()) {
		global $HM_FRONTENT_DIR;
		$wordsFile = $HM_FRONTENT_DIR.'/captcha/words/en.php';
		$resourcesPath = $HM_FRONTENT_DIR.'/captcha/resources';
		$this->set_wordsFile($wordsFile);
		$this->set_resourcesPath($resourcesPath);
    }
	
	public function set_wordsFile($wordsFile) {
		$this->wordsFile = $wordsFile;
	}
	public function get_wordsFile() {
		return $this->wordsFile;
	}
	public function set_resourcesPath($resourcesPath) {
		$this->resourcesPath = $resourcesPath;
	}
	public function get_resourcesPath() {
